...
$(function () {
    ...
    $(document).off("click").on("click","#startbtnnew", function () {
        ...
        if(t>0||typeof t=="undefined"){
           ajax2.post("http://typatest.pp.ua/quizz/quizzquizz.html", {"id": quizzid, "qnum": "0","teacher":t});
        }else{
    ...
    $(document).on("click", "#setpassw", function () {
        var passw = $("#passw").val();
        ajax2.post("http://typatest.pp.ua/quizz/quizzquizz.html", {"id": quizzid, "quizzpassw": passw});
    });
...
// Update the count down every 1 second
    ...
    var sender = {
        sendone: function () {
            ...
            var rid = selid[2];
            var qid = selid[1];
            ajax2.post("http://typatest.pp.ua/quizz/quizzquizz.html", {"id": quizzid, "qid": qid, "qnum": n, "r": rid, "type": 1});
        },
        sendchb: function () {
            ajax2.post("http://typatest.pp.ua/quizz/quizzquizz.html", {"id": quizzid, "qid": question_id, "qnum": n, "r": checkboxes, "type": 2});

        },
        sendshb: function () {
            ajax2.post("http://typatest.pp.ua/quizz/quizzquizz.html", {"id": quizzid, "qid": question_id, "qnum": n, "r": shba, "type": 3});
        },
        sendspi: function () {
